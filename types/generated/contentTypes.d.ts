...
export interface ApiAboutTheAppAboutTheApp extends Struct.CollectionTypeSchema {
  collectionName: 'about_the_apps';
  info: {
    displayName: 'About The App';
    pluralName: 'about-the-apps';
    singularName: 'about-the-app';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-the-app.about-the-app'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomepagesectionHomepagesection
  extends Struct.CollectionTypeSchema {
  collectionName: 'homepagesections';
  info: {
    displayName: 'homepagesection';
    pluralName: 'homepagesections';
    singularName: 'homepagesection';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    bannerImagesDesktop: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::homepagesection.homepagesection'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    TagsList: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-the-app.about-the-app': ApiAboutTheAppAboutTheApp;
      ...
      'api::homepagesection.homepagesection': ApiHomepagesectionHomepagesection;
